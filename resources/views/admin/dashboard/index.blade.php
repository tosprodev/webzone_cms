    ...
    <div class="main-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-xl-8 stretch-card">
			...
			<div class="modal fade bd-example-modal-lg" tabindex="-1" id="notificationModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-lg">
				<div class="modal-content">
				  <div class="modal-header">
					<h5 class="modal-title" id="myLargeModalLabel">All Notification</h5>
